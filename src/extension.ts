...
import { generateMockDataFromSwagger } from './mockGenerator';
			...
			switch (message.command) {
				case 'alert':
					...
					try {
						...
						const mockData = await generateMockDataFromSwagger(message.text);
...
function formatScenario(jsonData: any): string {
...
function getValueByTagName(json: any, tagName: string): any | null {
